              ...
              <div class="card-body">
                ...
                <div class="form-group" style="margin: 18px 0px;">
                  <div class="input-group mb-3">
                    <input type="text" class="form-control shadow-none search-input-custom" style="margin: 0px 8px; background-color: transparent;" v-model="search" @keypress.enter="searchData" placeholder="cari berdasarkan nama customer">
