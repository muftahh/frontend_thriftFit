        ...
        <div class="row align-items-center">
          <div class="col-lg-3 col-sm-4 col-md-4 col-5"> 
              <nuxt-link to="/" class="brand-wrap" data-abc="true">
                <img src="/images/logo.png" width="35" class="bg-light p-2 rounded">
                <span class="logo">Thirft <i>Fit</i></span>
              </nuxt-link>
          </div>
          ...
          <div class="col-lg-5 col-xl-4 col-sm-8 col-md-4 col-7">
            <div class="d-flex justify-content-end">
              <a href="#" class="btn search-button btn-md d-md-block ml-4 custom-text1"><i class="fa fa-shopping-cart "></i> <span class="ml-2">0</span> | Rp. 0</a>
            </div>
          </div>
        </div>
      </div>
...
.header-main {
  background: rgb(33, 38, 49) !important;
}
.custom-text1 {
  color: black;
}
/* tandai */
.custom-text1:hover,  .nav-link:hover{
  color: rgb(33, 38, 49);
